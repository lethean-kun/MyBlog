                ...
                <div>
                    <div id="cbody_bar_r">
                        <span><b>博客详情</b></span>
			                ...
			                <div class="bw_text">
			                    <span class="title_span"><a class="bw_text_title" href="text.html">${topic.title}</a><br>(${topic.addtime })<a style="float: right;" class="bw_text_title_bt" href="###" target="_self">作者：${topic.user.username}</a></span>
			                    <br />
			                    ...
			                    <div class="text_text"><p>&nbsp;&nbsp;${topic.contents}</p></div>

			                    <br />
			                    <span class="bw_bottom"><a class="bw_bottom_bt" href="###" target="_self">阅读</a>(${topic.views} ) | <a class="bw_bottom_bt" href="###" target="_self" onclick="ok()">评论</a>(${topic.replys}) |  <a class="bw_bottom_bt" href="###" target="_self">收藏</a>(10)</span>
			                </div>
			                
			                <div id="open" style="width:660px;height:180px;display:none;margin-left: 30px">
